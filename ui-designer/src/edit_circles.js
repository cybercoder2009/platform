...
export const EditCircles = (props) => {
    ...
    return (
        <>
            ...
            <div>
                <span>value</span>
                <input type="number" value={props.shape.value} onChange={e=>onChange('value', parseInt(e.target.value))} />
            </div>
            <div>
                <span>max</span>
                <input type="number" value={props.shape.max} onChange={e=>onChange('max', parseInt(e.target.value))} />
            </div>
            <div>
                <span>x</span>
            ...
            <div>
                <span>margin</span>
                <input type="number" value={props.shape.margin} onChange={e=>onChange('margin', parseInt(e.target.value))} />
            </div>
        </>
    )
}